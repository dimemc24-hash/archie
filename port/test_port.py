...
check_close("costFor glm in",  l1.cost_for("z-ai/glm-5.2", 1_000_000, 0), 0.93)
check_close("costFor glm out", l1.cost_for("z-ai/glm-5.2", 0, 1_000_000), 3.00)
...
check_close("costFor deepseek-v4-pro in", l1.cost_for("deepseek/deepseek-v4-pro", 1_000_000, 0), 0.43)
check_close("costFor sonnet-5 in+out", l1.cost_for("anthropic/claude-sonnet-5", 1_000_000, 1_000_000), 2.00 + 10.00)
check_close("costFor glm-4.6v out", l1.cost_for("z-ai/glm-4.6v", 0, 1_000_000), 0.90)
...
check_close("spendTodayUsd total", l1.spend_today_usd(), 0.93 + 3.00)
check_close("spendTodayUsd codex", l1.spend_today_usd("codex"), 3.93)
